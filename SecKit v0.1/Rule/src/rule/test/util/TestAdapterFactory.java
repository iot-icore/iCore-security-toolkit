...
public class TestAdapterFactory extends AdapterFactoryImpl {
    ...
    protected TestSwitch<Adapter> modelSwitch =
        new TestSwitch<Adapter>() {
            ...
            @Override
            public Adapter caseTestSet(TestSet object) {
                return createTestSetAdapter();
            }
            @Override
            public Adapter caseSimulatedTimeStepWindow(SimulatedTimeStepWindow object) {
                return createSimulatedTimeStepWindowAdapter();
            }
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link rule.test.TestCase <em>Case</em>}'.
     * <!-- begin-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link rule.test.TestSet <em>Set</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public Adapter createTestSetAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link rule.test.SimulatedTimeStepWindow <em>Simulated Time Step Window</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public Adapter createSimulatedTimeStepWindowAdapter() {
        return null;
    }
