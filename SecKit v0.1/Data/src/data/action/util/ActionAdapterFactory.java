...
public class ActionAdapterFactory extends AdapterFactoryImpl {
    ...
    protected ActionSwitch<Adapter> modelSwitch =
        new ActionSwitch<Adapter>() {
            @Override
            public Adapter caseModifyData(ModifyData object) {
                return createModifyDataAdapter();
            }
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link data.action.ModifyData <em>Modify Data</em>}'.
     * <!-- begin-user-doc -->
     ...
     * @generated
     */
    public Adapter createModifyDataAdapter() {
        return null;
    }
