...
public class EventAdapterFactory extends AdapterFactoryImpl {
    ...
    protected EventSwitch<Adapter> modelSwitch =
        new EventSwitch<Adapter>() {
            @Override
            public Adapter caseContextSituationEvent(ContextSituationEvent object) {
                return createContextSituationEventAdapter();
            }
            @Override
            public Adapter caseContextInformationEvent(ContextInformationEvent object) {
                return createContextInformationEventAdapter();
            }
            @Override
            public Adapter caseContextSituationEventPattern(ContextSituationEventPattern object) {
                return createContextSituationEventPatternAdapter();
            }
            @Override
            public Adapter caseContextInformationEventPattern(ContextInformationEventPattern object) {
                return createContextInformationEventPatternAdapter();
            }
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link context.event.ContextSituationEvent <em>Context Situation Event</em>}'.
     * <!-- begin-user-doc -->
     ...
     * @generated
     */
    public Adapter createContextSituationEventAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link context.event.ContextInformationEvent <em>Context Information Event</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public Adapter createContextInformationEventAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link context.event.ContextSituationEventPattern <em>Context Situation Event Pattern</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public Adapter createContextSituationEventPatternAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link context.event.ContextInformationEventPattern <em>Context Information Event Pattern</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public Adapter createContextInformationEventPatternAdapter() {
        return null;
    }
