...
public class ContextAdapterFactory extends AdapterFactoryImpl {
    ...
    protected ContextSwitch<Adapter> modelSwitch =
        new ContextSwitch<Adapter>() {
            @Override
            public Adapter caseContextDesignModel(ContextDesignModel object) {
                return createContextDesignModelAdapter();
            }
            @Override
            public Adapter caseContextRuntimeModel(ContextRuntimeModel object) {
                return createContextRuntimeModelAdapter();
            }
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link context.ContextDesignModel <em>Design Model</em>}'.
     * <!-- begin-user-doc -->
     ...
     * @generated
     */
    public Adapter createContextDesignModelAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link context.ContextRuntimeModel <em>Runtime Model</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public Adapter createContextRuntimeModelAdapter() {
        return null;
    }
