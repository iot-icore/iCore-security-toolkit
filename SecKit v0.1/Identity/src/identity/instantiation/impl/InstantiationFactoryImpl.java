...
public class InstantiationFactoryImpl extends EFactoryImpl implements InstantiationFactory {
    ...
    public EObject create(EClass eClass) {
        switch (eClass.getClassifierID()) {
            case InstantiationPackage.IDENTITY_INSTANTIATION: return createIdentityInstantiation();
            default:
     ...
     * @generated
     */
    public IdentityInstantiation createIdentityInstantiation() {
        IdentityInstantiationImpl identityInstantiation = new IdentityInstantiationImpl();
