...
public class InstantiationAdapterFactory extends AdapterFactoryImpl {
    ...
    protected InstantiationSwitch<Adapter> modelSwitch =
        new InstantiationSwitch<Adapter>() {
            @Override
            public Adapter caseIdentityInstantiation(IdentityInstantiation object) {
                return createIdentityInstantiationAdapter();
            }
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link identity.instantiation.IdentityInstantiation <em>Identity Instantiation</em>}'.
     * <!-- begin-user-doc -->
     ...
     * @generated
     */
    public Adapter createIdentityInstantiationAdapter() {
        return null;
    }
