...
public class PatternAdapterFactory extends AdapterFactoryImpl {
    ...
    protected PatternSwitch<Adapter> modelSwitch =
        new PatternSwitch<Adapter>() {
            @Override
            public Adapter caseIdentityPattern(IdentityPattern object) {
                return createIdentityPatternAdapter();
            }
            @Override
            public Adapter caseIdentityAttributePattern(IdentityAttributePattern object) {
                return createIdentityAttributePatternAdapter();
            }
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link identity.pattern.IdentityPattern <em>Identity Pattern</em>}'.
     * <!-- begin-user-doc -->
     ...
     * @generated
     */
    public Adapter createIdentityPatternAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link identity.pattern.IdentityAttributePattern <em>Identity Attribute Pattern</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public Adapter createIdentityAttributePatternAdapter() {
        return null;
    }
