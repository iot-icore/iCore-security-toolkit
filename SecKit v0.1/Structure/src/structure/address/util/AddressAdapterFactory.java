/**
 */
package structure.address.util;
...
public class AddressAdapterFactory extends AdapterFactoryImpl {
    ...
    protected AddressSwitch<Adapter> modelSwitch =
        new AddressSwitch<Adapter>() {
            ...
            @Override
            public Adapter caseAddressInstance(AddressInstance object) {
                return createAddressInstanceAdapter();
            }
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link structure.address.IpAddress <em>Ip Address</em>}'.
     * <!-- begin-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link structure.address.AddressType <em>Type</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link structure.address.AddressInstance <em>Instance</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public Adapter createAddressInstanceAdapter() {
        return null;
    }
