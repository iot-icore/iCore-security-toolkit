...
public class AddressSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case AddressPackage.IP_ADDRESS: {
                IpAddress ipAddress = (IpAddress)theEObject;
                T result = caseIpAddress(ipAddress);
                if (result == null) result = caseAddressType(ipAddress);
            ...
            case AddressPackage.ADDRESS_INSTANCE: {
                AddressInstance addressInstance = (AddressInstance)theEObject;
                T result = caseAddressInstance(addressInstance);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
     ...
     * @generated
     */
    public T caseAddressInstance(AddressInstance object) {
        return null;
    }
