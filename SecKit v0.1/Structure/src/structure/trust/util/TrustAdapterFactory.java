...
public class TrustAdapterFactory extends AdapterFactoryImpl {
    ...
    protected TrustSwitch<Adapter> modelSwitch =
        new TrustSwitch<Adapter>() {
            @Override
            public Adapter caseStructuralQuality(StructuralQuality object) {
                return createStructuralQualityAdapter();
            }
            @Override
            public Adapter caseResistanceToTampering(ResistanceToTampering object) {
                return createResistanceToTamperingAdapter();
            }
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link structure.trust.StructuralQuality <em>Structural Quality</em>}'.
     * <!-- begin-user-doc -->
     ...
     * @generated
     */
    public Adapter createStructuralQualityAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link structure.trust.ResistanceToTampering <em>Resistance To Tampering</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public Adapter createResistanceToTamperingAdapter() {
        return null;
    }
