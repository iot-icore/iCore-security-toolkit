...
public class StructureAdapterFactory extends AdapterFactoryImpl {
    ...
    protected StructureSwitch<Adapter> modelSwitch =
        new StructureSwitch<Adapter>() {
            @Override
            public Adapter caseStructuralDesignModel(StructuralDesignModel object) {
                return createStructuralDesignModelAdapter();
            }
            @Override
            public Adapter caseStructuralRuntimeModel(StructuralRuntimeModel object) {
                return createStructuralRuntimeModelAdapter();
            }
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link structure.StructuralDesignModel <em>Structural Design Model</em>}'.
     * <!-- begin-user-doc -->
     ...
     * @generated
     */
    public Adapter createStructuralDesignModelAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link structure.StructuralRuntimeModel <em>Structural Runtime Model</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public Adapter createStructuralRuntimeModelAdapter() {
        return null;
    }
