/**
 */
package structure.pattern.util;
...
public class PatternAdapterFactory extends AdapterFactoryImpl {
    ...
    protected PatternSwitch<Adapter> modelSwitch =
        new PatternSwitch<Adapter>() {
            @Override
            public Adapter caseEntityPattern(EntityPattern object) {
                return createEntityPatternAdapter();
            }
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link structure.pattern.EntityPattern <em>Entity Pattern</em>}'.
     * <!-- begin-user-doc -->
     ...
     * @generated
     */
    public Adapter createEntityPatternAdapter() {
        return null;
    }
