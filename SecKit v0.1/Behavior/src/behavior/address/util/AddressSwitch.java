...
public class AddressSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case AddressPackage.BEHAVIOR_ADDRESS_TYPE: {
                BehaviorAddressType behaviorAddressType = (BehaviorAddressType)theEObject;
                T result = caseBehaviorAddressType(behaviorAddressType);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case AddressPackage.PROCESS_IDENTIFIER: {
                ProcessIdentifier processIdentifier = (ProcessIdentifier)theEObject;
                T result = caseProcessIdentifier(processIdentifier);
                if (result == null) result = caseBehaviorAddressType(processIdentifier);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Behavior Address Type</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Behavior Address Type</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseBehaviorAddressType(BehaviorAddressType object) {
        return null;
    }
