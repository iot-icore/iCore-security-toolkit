...
public class AddressAdapterFactory extends AdapterFactoryImpl {
    ...
    protected AddressSwitch<Adapter> modelSwitch =
        new AddressSwitch<Adapter>() {
            @Override
            public Adapter caseBehaviorAddressType(BehaviorAddressType object) {
                return createBehaviorAddressTypeAdapter();
            }
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link behavior.address.BehaviorAddressType <em>Behavior Address Type</em>}'.
     * <!-- begin-user-doc -->
     ...
     * @generated
     */
    public Adapter createBehaviorAddressTypeAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link behavior.address.ProcessIdentifier <em>Process Identifier</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
