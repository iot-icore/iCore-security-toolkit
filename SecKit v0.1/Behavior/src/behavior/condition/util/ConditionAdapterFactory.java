...
public class ConditionAdapterFactory extends AdapterFactoryImpl {
    ...
    protected ConditionSwitch<Adapter> modelSwitch =
        new ConditionSwitch<Adapter>() {
            @Override
            public Adapter caseEvaluateAction(EvaluateAction object) {
                return createEvaluateActionAdapter();
            }
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link behavior.condition.EvaluateAction <em>Evaluate Action</em>}'.
     * <!-- begin-user-doc -->
     ...
     * @generated
     */
    public Adapter createEvaluateActionAdapter() {
        return null;
    }
