/**
 */
package behavior.condition.util;
...
public class ConditionSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case ConditionPackage.EVALUATE_ACTION: {
                EvaluateAction evaluateAction = (EvaluateAction)theEObject;
                T result = caseEvaluateAction(evaluateAction);
                if (result == null) result = caseAtom(evaluateAction);
                if (result == null) result = caseNullary(evaluateAction);
                if (result == null) result = caseElement(evaluateAction);
                if (result == null) result = caseArity(evaluateAction);
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Evaluate Action</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Evaluate Action</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseEvaluateAction(EvaluateAction object) {
        return null;
    }
