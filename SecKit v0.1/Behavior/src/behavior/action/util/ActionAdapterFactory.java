...
public class ActionAdapterFactory extends AdapterFactoryImpl {
    ...
    protected ActionSwitch<Adapter> modelSwitch =
        new ActionSwitch<Adapter>() {
            @Override
            public Adapter caseBehaviorExecution(BehaviorExecution object) {
                return createBehaviorExecutionAdapter();
            }
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link behavior.action.BehaviorExecution <em>Behavior Execution</em>}'.
     * <!-- begin-user-doc -->
     ...
     * @generated
     */
    public Adapter createBehaviorExecutionAdapter() {
        return null;
    }
