...
public class ActionFactoryImpl extends EFactoryImpl implements ActionFactory {
    ...
    public EObject create(EClass eClass) {
        switch (eClass.getClassifierID()) {
            case ActionPackage.BEHAVIOR_EXECUTION: return createBehaviorExecution();
            default:
     ...
     * @generated
     */
    public BehaviorExecution createBehaviorExecution() {
        BehaviorExecutionImpl behaviorExecution = new BehaviorExecutionImpl();
