 ...
 * <ul>
 *   <li>{@link behavior.type.impl.ActionTypeImpl#getInstances <em>Instances</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ActionTypeImpl extends ActivityTypeImpl implements ActionType {
    /**
    ...
    protected EClass eStaticClass() {
        return TypePackage.Literals.ACTION_TYPE;
    }
    ...
    public EList<Action> getInstances() {
        if (instances == null) {
            instances = new EObjectWithInverseResolvingEList<Action>(Action.class, this, TypePackage.ACTION_TYPE__INSTANCES, InstancePackage.ACTION__TYPE);
        }
        return instances;
    }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case TypePackage.ACTION_TYPE__INSTANCES:
